...
class WebhookTestCase(WorkerBaseTestCase):
    ...
    @BaseTestCase.cases(
        ...
        ("GET__no_headers__timeout", "GET", {}, {"connect": 6, "read": 7}),
        (
        ...
        ("GET__no_headers__no_timeout", "GET", {}, {}),
        (
        ...
        ("POST__no_headers__timeout", "POST", {}, {"connect": 6, "read": 7}),
        (
        ...
        ("POST__no_headers__no_timeout", "POST", {}, {}),
        (
        ...
        ("PUT__no_headers__timeout", "PUT", {}, {"connect": 6, "read": 7}),
        (
        ...
        ("PUT__no_headers__no_timeout", "PUT", {}, {}),
        (
        ...
        ("PATCH__no_headers__timeout", "PATCH", {}, {"connect": 6, "read": 7}),
        (
        ...
        ("PATCH__no_headers__no_timeout", "PATCH", {}, {}),
        (
        ...
        ("DELETE__no_headers__timeout", "DELETE", {}, {"connect": 6, "read": 7}),
        (
        ...
        ("DELETE__no_headers__no_timeout", "DELETE", {}, {}),
    )
    @mock.patch("requests.request")
    def test_worker(self, method, headers, timeout, mocked_request):
        files = None
        response = ""
        ...
        if timeout:
            _timeout = (timeout["connect"], timeout["read"])
        else:
            _timeout = (
                5,
                5,
    ...
    @mock.patch("requests.request")
    def test_worker_payload_wrapper(self, payload_wrapper, mocked_request):
        response = ""
        mocked_request.return_value = self._fake_http_response(
            status=200,
            json_data=response,
