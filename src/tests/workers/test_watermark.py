...
class WatermarkImageTestCase(WorkerBaseTestCase):
    ...
    image_file_location = os.path.join(data_location, "image.png")
    watermark_file_location = os.path.join(data_location, "watermark.png")

    image_as_file = open(image_file_location, "rb")
    watermark_as_file = open(watermark_file_location, "rb")

    image_as_data = base64.b64encode(
        open(os.path.join(data_location, "image.png"), "rb").read()
    ).decode()
    ...
    @BaseTestCase.cases(
        ...
        (
            ...
            {"watermark_image": watermark_as_file, "gravity": "NorthWest"},
            image_as_file,
            "watermarked_northwest.png",
        ),
        (
            "file_image_with_file_watermark_north",
            {"watermark_image": watermark_as_file, "gravity": "North"},
            image_as_file,
            "watermarked_north.png",
        ),
        (
            "file_image_with_file_watermark_northeast",
            {"watermark_image": watermark_as_file, "gravity": "NorthEast"},
            image_as_file,
            "watermarked_northeast.png",
        ),
        (
            "file_image_with_file_watermark_west",
            {"watermark_image": watermark_as_file, "gravity": "West"},
            image_as_file,
            "watermarked_west.png",
        ),
        (
            "file_image_with_file_watermark_center",
            {"watermark_image": watermark_as_file, "gravity": "Center"},
            image_as_file,
            "watermarked_center.png",
        ),
        (
            "file_image_with_file_watermark_east",
            {"watermark_image": watermark_as_file, "gravity": "East"},
            image_as_file,
            "watermarked_east.png",
        ),
        (
            "file_image_with_file_watermark_southwest",
            {"watermark_image": watermark_as_file, "gravity": "SouthWest"},
            image_as_file,
            "watermarked_southwest.png",
        ),
        (
            "file_image_with_file_watermark_south",
            {"watermark_image": watermark_as_file, "gravity": "South"},
            image_as_file,
            "watermarked_south.png",
        ),
        (
            "file_image_with_file_watermark_southeast",
            {"watermark_image": watermark_as_file, "gravity": "SouthEast"},
            image_as_file,
            "watermarked_southeast.png",
        ),
    ...
    def test_worker(self, in_config, value, expectation):
        result = self.worker_class(
            ...
            pipeline_processor={"id": "watermark_image", "in_config": in_config},
        ).execute(value)
        ...
        self.assertTrue(
            filecmp.cmp(
                ...
                os.path.join(self.data_location, expectation),
            ),
            file_id,
        )
