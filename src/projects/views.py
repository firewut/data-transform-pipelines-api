...
class PipelineResultFileViewSet(mixins.RetrieveModelMixin, viewsets.GenericViewSet):
    ...
    def process(self, request, pk=None, **kwargs):
        ...
        if isinstance(request.data, type({})):
            if "application/json" in request.content_type:
                ...
                pipeline_processors = (
                    json.loads(request.data.get("processors", "{}"))
        ...
        pipeline_serializer().check_processors(instance.processors)
        ...
        pipeline_result = instance.create_result(input_data)
